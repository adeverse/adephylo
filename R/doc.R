...
#' Stéphane Dray <dray@@biomserv.univ-lyon1.fr> and Anders Ellern Bilgrau
...
#' @note This dataset replaces the former version in ade4.
#' @source Diniz-Filho, J. A. F., and N. M. Tôrres. (2002) Phylogenetic
...
#' history patterns of teleos fishes.  \emph{Oïkos}, \bold{91}, 255--270.
...
#' @name palm
#' @docType data
#' @format \code{palm} is a list containing the 2 following objects:
#' \itemize{
#' \item{tre}{is a character string giving the phylogenetic tree in Newick
#' format.}
#' \item{traits}{is a data frame with 66 species (rows) and 7 traits
#' (columns).}
#' }
#' @note This dataset replaces the former version in ade4.
#' @source This data set was obtained by Clémentine Gimaret-Carpentier
...
#' PÃ©labon et al. (1995). It also gives 4 traits corresponding to these 18
#' species.
#'
...
#' @note This dataset replaces the former version in ade4.
#' @source Data were obtained from PÃ©labon, C., Gaillard, J.M., Loison, A. and
